...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form action="<?= $ADMIN_URL ?>feedback/save-edit.php" method="post">
        <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="date" name="created_at" class="form-control" value="<?= $feed['created_at']; ?>">
            <?php 
              if(isset($_GET['cr'])){
                ?>
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea rows="5" class="form-control" name="content"><?= $feed['content']; ?></textarea>
            <?php 
              if(isset($_GET['c'])){
                ?>
